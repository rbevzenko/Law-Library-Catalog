...
export default function App() {
  ...
  const {
    ...
    bulkAddBooks, importPaperBooks, bulkUpdateBooks, fixYearsFromRegex, fixExcelImport, fixCorruptedTitles, removeDuplicates, clearAllBooks, exportToJSON, exportToCSV, importFromJSON,
